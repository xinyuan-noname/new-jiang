game.import("extension", function (lib, game, ui, get, ai, _status) {
    return {
        name: "新将包", content: function (config, pack) {
            if (lib.config.extensions.contains('枝头折百花')) {
                        ...
                        if (e.target.classList.contains("avatar")) {
                            if (e.target.parentNode.classList.contains("player")) {
                                if (game.xjb_condition(1, 2)) {
                                    var next = e.target.parentNode.loseHp().set("source", game.me)
            ...
            if (lib.config.xjb_hun) {
                ...
                if (lib.config.xjb_bianshen == 1) {
                    lib.extensionMenu.extension_新将包.hun_bianshen = {
                        ...
                        clear: true,
                        onclick: function (layout) {
                            game.xjb_create.alert("变身武将已改为全局技能！祝使用愉快！")
                ...
                if (!lib.config.xjb_chupingjisha) {
                    lib.extensionMenu.extension_新将包.xjb_chupingjisha_hun_open = {
                        name: '<img src="' + lib.xjb_src + 'image/xjb_locked.png" width="16">' + '点我解锁触屏击杀功能',
                        clear: true,
                        onclick: function () {
                            var that = this
                            if (lib.config.xjb_hunbi >= 50) {
                                game.xjb_create.confirm('你已有' + lib.config.xjb_hunbi + '个魂币，解锁触屏击杀功能需要50个魂币，确定要解锁吗？', function () {
                                    game.cost_xjb_cost(1, 50)
                                    game.saveConfig('xjb_chupingjisha', 1);
                                    that.innerHTML = '<img src="' + lib.xjb_src + 'image/xjb_open.png" width="16">' + '你已解锁触屏击杀'
                                })
                            }
                    ...
                    let on_or_off3 = function () {
                        ...
                        return '<img src="' + lib.xjb_src + 'image/xjb_close.png" width="16">' + '<font color="red">关闭触屏击杀</font>'
                    }
                    ...
                    qimendunjia: {
                        ...
                        content: function () {
                            ...
                            if (target.name1.indexOf("zhugeliang") > -1) {
                                ...
                                target.fc_X(true, 'choose', 'needResult', { choice: list, storage: "qimendunjia", chopro: "请选择一个变身武将的X技能力" })
                                event.bool = true
                            }
                            'step 1'
                ...
                skill: {
                    "xin_jincui": {
                        ...
                        content: function () {
                            ...
                            var card2 = game.createCard2(get.typeCard("trick").randomGet())
                    ...
                    "xin_huzhu": {
                        ...
                        content: function () {
                            'step 0'
                            player.chooseToDiscard('hes', 1, '弃置一张牌，或点取消失去一点体力').set('ai', function (card) {
                    ...
                    "xjb_2": {
                        ...
                        "xjb_molizeLingli": {
                            ...
                            content: function () {
                                ...
                                "step 2"
                                let eventLine = xjb_lingli.event.match(-1 * event.num)
                                eventLine.forEach(function (event) {
                                    this[event]()
                                }, event.target)
                                "step 3"
                        ...
                        "xjb_buildBridge": {
                            ...
                            content: function () {
                                ...
                                let next = event.player.chooseButton([wordswords(),
                                [list, "tdnodes"]
                                ], [0, 1])
                                ...
                                next.appendC = ["调整放置的导魔介质", div]
                                if (player !== game.me) player.storage.xjb_daomoMax = range.max
                                "step 1"
                    ...
                    "xjb_3": {
                        skillTag: function () {
                            ...
                            lib.skill._xjb_suidongSkill = {
                                ...
                                filter: function (event, player) {
                                    ...
                                    for (let i = 1; i < 9; i++) {
                                        let theName = event.getParent(i)?.name;
                        ...
                        Translate: function () {
                            lib.translate.xin_guimeng_1 = "血梦"
                            lib.translate.xin_guimeng_1_info = "使用牌混乱！"
                        ...
                        uniqueSkill: function () {
                            lib.skill._tianxing = {
                                ...
                                content: function () {
                                    ...
                                    for (var i = 0; i < lib.skill._tianxing.load.length; i++) {
                                        lib.skill._tianxing.load[i]()
                                    }
                                },
                            };
                    ...
                    "xjb_6": {
                        xjb_storage: function () {
                            get.xjb_storage = function () {
                                ...
                                let target = lib.config.xjb_count[player]?.xjb_storage
                                if (!target) return;
                        ...
                        bianshen: function () {
                            ...
                            lib.translate._xjb_bianshen = "变身武将"
                        },
                        CharacterPack: function () {
                            ...
                            const xuemoElse = ['ext:新将包/sink/xjb_xuemo/xuemo1.jpg', 'xuemo']
                            lib.character.xjb_xuemo = ["none", "xjb_hun", 2, xuemoSkill, xuemoElse]
                            ...
                            lib.character.xjb_timer = ["none", "xjb_hun", 3, timerSkill, timerElse]
...
";
                    ...
                    "xjb_8": {
                        leadVitalSkill: function () {
                            lib.skill._xjb_skillWhendie = {
                                direct: true,
                                trigger: {
                                    global: "dieBegin",
                                },
                                filter: function (event, player) {
                                    if (_status.xjb_level && _status.xjb_level.keyCharacter) {
                                        return _status.xjb_level.keyCharacter.contains(event.player) && player == game.me
                                    }
                                },
                                content: function () {
                                    "step 0"
                                    game.xjb_RPGnext()
                                    game.pause()
                                    var control1 = ui.create.control("结束并存档", func1)
                                    var control2 = ui.create.control("继续下一关", func2)
                                    function func1() {
                                        game.resume()
                                        if (_status.xjb_level.next) _status.xjb_level.number = _status.xjb_level.next
                                        control1.close()
                                        control2.close()
                                        var storage = game.me.xjb_saveStorage()
                                        game.xjb_back = null
                                    }
                                    function func2() {
                                        control1.close()
                                        control2.close()
                                        if (_status.xjb_level.next) {
                                            game.xjb_bossLoad(_status.xjb_level.next, game.me)
                                            trigger.cancel()
                                        } else {
                                            game.resume()
                                        }
                            ...
                            lib.skill._xjb_TryYourBest = {
                                ...
                                filter: function (event, player) {
                                    ...
                                    return _status.brawl.scene.name === "xjb_tyb"
                                },
                                content: function () {
                                    "step 0"
                                    if (player != game.me) {
                                    ...
                                    "step 1"
                                    if (player.skills.length > 5) player.xjb_chooseSkillToCard(player.skills.length - 5)
                                    "step 2"
                                    game.pause()
                                    function func() {
                                        ...
                                        function func1() {
                                            ...
                                            play.close.addEventListener(lib.config.touchscreen ? 'touchend' : 'click', func)
                                            game.xjb_back = null
                                        }
                                        function func2() {
                                            control1.close()
                                            control2.close()
                                            var storage = game.me.xjb_readStorage()
                                            storage.close.addEventListener(lib.config.touchscreen ? 'touchend' : 'click', func)
                                            game.xjb_back = null
                                        }
                                    }
                                    func()
                        ...
                        myFunc: function () {
                            let xjb_xxxPlay = {
                                "幻想乡玩家": ["幻想乡玩家",
                                    lib.xjb_src + "sink/xjb_newCharacter/Red/小红.png",
                                    "Red0001"],
                                "自我试练": ["自我试练",
                                    lib.xjb_src + lib.config.xjb_newcharacter.selectedSink.slice(8),
                                    "SELF0001"],
                            }
                            ui.create.xjb_newPlayLi = function (str, img, num, ul, close, player) {
                                var li = document.createElement("li")
                                ui.xjb_giveStyle(li, {
                                    height: "88%", width: "23%", "color": "#FF0000",
                            ...
                            ui.create.xjb_thePlay = function () {
                                var alsj = ui.create.xjb_back('双击以开始剧情。')
                                var back = alsj[0], ul = document.createElement("ul"), list = [...arguments], lis = []
                                ui.xjb_giveStyle(ul, {
                                    height: "78%", width: "88%",
                                ...
                                for (var i = 0; i < arguments.length; i++) {
                                    if (typeof arguments[i] === "string") {
                                        if (xjb_xxxPlay[arguments[i]]) {
                                            var red = ui.create.xjb_newPlayLi(...xjb_xxxPlay[arguments[i]], ul, back, arguments[arguments.length - 1])
                                            lis.push(red)
                                        }
                                    }
                                }
                        ...
                        level: function () {
                            ...
                            let Red = lib.xjb_src + 'sink/xjb_newCharacter/Red/小红.png'
                                    ...
                                    SELF0001: {
                                        init: function () {
                                            ...
                                            game.xjb_dialog([
                                                ...
                                                game.players[1].init("xjb_newCharacter");
                                                game.players[1].hp = game.players[1].maxHp = game.me.maxHp;
                                                game.players[1].update();
                                                _status.xjb_level.keyCharacter.add(game.players[1])
                                            ...
                                            game.xjb_dialog([
                                                ...
                                                [, , "blue", "(瞬间化成成千上万个，不约而同地" + LHName + "袭来)"],
                                                [, , "red", "！！！"]
                                            ])
                                        }
                                    },
                                        ...
                                        init: function (player) {
                                            ...
                                            game.xjb_dialog(
                                                [
                                                    ...
                                                    new Array(2, 3, 4, 5, 6, 7).forEach(function (i) {
                                                        var player = game.addPlayer(i, "xjb_newCharacter")
                                                        player.hp = player.maxHp = game.me.maxHp;
                                                        player.update()
                                                        player.getId()
                                                        player.identity = "fan"
                                    ...
                                    SELF0003: {
                                        init: function () {
                                            _status.xjb_level = {
                                                ...
                                                Type: "SELF",
                                                keyCharacter: [],
                                                finalDialog: undefined
                                            }
                                            game.xjb_dialog([
                                                [LH, lib.config.xjb_newcharacter.name, "green", ""]
                                            ], function () {
                                                game.players[1].dieToWin = true
                                                game.players[1].xjb_dialog = [
                                                    [LH, lib.config.xjb_newcharacter.name, "green", ""]
                                                ]
                                            })
                                        }
                                        ...
                                        init: function (player) {
                                            ...
                                            game.xjb_dialog(
                                                [
                                                    ...
                                                    [Red, "???", "red", "什么时候冬天的阳光也这么刺眼了啊……"],
                                                    ["none", "旁白", "white", "被阳光强迫着醒来的少年有些不情愿地翻了个身，然后伸手试图把身边的被褥拉到身上来。"],
                                                    [, , , "少年心中一惊，这才发现自己身下并不是自己那张略窄却很舒适的小床，而是有些松散并且有点湿润的土地。"],
                                                    [, , , "想到这里，少年的睡意全无，连忙一个翻身坐了起来，向四周打量着。"],
                                                    [, , , "一棵棵参天大树在少年的周围耸立着，裸露的地面上零零散散地分布着几片小小的草坪，空气中弥漫着一股湿润的气息，仔细看去还能发现空气中混杂着一丝淡淡的雾气。"],
                                                    [Red, "???", "red", "见鬼了……"],
                    ...
                    "xjb_9": {
                        dialog: function () {
                            ...
                            game.xjb_create.chooseAnswer = function (str, choices_result, src) {
                                ...
                                choices.forEach(function (item, index) {
                                    ...
                                    Str = Str + "<hr>" + `<font color=${colorList[item]}>选项` + (index + 1) + "：" + this[item][0] + "</font>"
                                    resultList.push(this[item][1])
                                    NumberList.push(index + 1)
                                }, choices_result)
                                var dialog = ui.create.xjb_dialogBase(...NumberList)
                                ui.xjb_giveStyle(dialog, {
                                    overflow: "",
                                    height: "258.4px",
                                    top: "-120px"
                                ...
                                choices.forEach(function (item, index) {
                                    this[index].addEventListener(lib.config.touchscreen ? 'touchend' : 'click', resultList[index])
                                }, dialog.buttons)
                                if (src) {
                                ...
                                if (list) {
                                    for (let i in list) {
                                        ...
                                        span.update = function () {
                                            if (lib.config[i] === undefined) {
                                                span.innerHTML = '【🔐已锁定】'
                                            } else if (lib.config[i] === 2) {
                                                span.innerHTML = '【🔒已关闭】'
                                                if (dialog.buttons[0].isOpened.contains(i)) dialog.buttons[0].isOpened.remove(i)
                                                dialog.buttons[0].isClosed.add(i)
                                            } else if (lib.config[i] == 1) {
                                                span.innerHTML = '【🔓已开启】'
                                                if (dialog.buttons[0].isClosed.contains(i)) dialog.buttons[0].isClosed.remove(i)
                        ...
                        title: function () {
                            ...
                            game.xjb_Intro = function (playerName) {
                                //生成界面
                                let intro = ui.create.xjb_double("双击称号一览中的称号可设置称号")
                                ...
                                intro.right.clear = function () {
                                    //清除技能   
                                    intro.right.player.additionalSkills.length = 0
                                    intro.right.player.skills.length = 0
                                    intro.right.player.hiddenSkills.length = 0
                                    intro.right.player.invisibleSkills.length = 0
                                    intro.right.player.init(intro.right.character_id)
                                    intro.right.player.name = intro.right.player.name1;
                                    intro.right.player.skills = lib.character[intro.right.player.name][3] || [];
                                    intro.right.player.sex = lib.character[intro.right.player.name][0];
                                    if (intro.right.player.group === 'unknown') this.group = lib.character[intro.right.player.name][1];
                                    intro.right.player.classList.remove('unseen');
                                ...
                                data.addEventListener(lib.config.touchscreen ? 'touchend' : 'click', function () {
                                    ...
                                    let arr1 = Object.keys(count).filter(item => {
                                        if (["HpCard", "uniqueSkill", "titles", "skill", "xjb_storage", "dialog", "book", "daomo", "lingtan", "lingfa"].contains(item))
                                            return false
                                        return true
                                    })
                                ...
                                bag.addEventListener(lib.config.touchscreen ? 'touchend' : 'click', function () {
                                    ...
                                    game.xjb_getSb.means(intro.right.character_id).forEach(i => {
                                        if (i.num > 0) xjb_count_bag.appendChild(i.organize())
                                    })
                            ...
                            ui.create.xjb_theStorage = function (storage, num) {
                                ...
                                div.update = function () {
                                    ...
                                    ui.xjb_giveStyle(this, {
                                        "background-image": "linear-gradient(rgba(255,225,255,0.6), rgba(255,225,255,0.6)),url(" + lib.xjb_src + "lingli/timer.jpg)",
                                    })
...
手牌区牌数/装备区牌数/判定区牌数/特殊区牌数/武将牌上牌数:${this.map.character.h.length}/${this.map.character.e.length}/${this.map.character.j.length}/${this.map.character?.s?.length}/${this.map.character?.x?.length},
`)
                                }
                                    ...
                                    content: function () {
                                        let list = {
                                            '战狂魂使': [function (current) {
                                                current.xjb_addSkillCard("xin_guimeng_1")
                                            }, function (current) {
                                                current.gain(game.createCard2("xjb_shenshapo", "", 1), "gain2")
                                            }, '④你控制的角色进入阵法〖血梦〗；<br>⑤该魂使开局获得一张 神杀破'],
                                            '旋风魂使': [function (current) {
                                        ...
                                        game.countPlayer(function (current) {
                                            if (current != player) {
                                                list[lib.translate[player.name1]][0](current)
                                                current.showCharacter(2)
                                                if (current.maxHp > 5) current.maxHp = 1
                                            } else if (current == player) {
                                                list[lib.translate[player.name1]][1](current)
                                                current.xjb_addSkillCard("xin_ziruo")
                                            }
                                            current.xjb_addSkillCard("xjb_lunhui")
                                        })
                                        game.removeGlobalSkill("_xjb_cardStore")
                                        let inform = function () {
                    ...
                    "+ extraStr, function () {
                        ...
                        "xjb_count": function () {
                            ...
                            for (var i in list) {
                                ...
                                if (1) {
                                    ...
                                    if (!target.xuemo) target.xuemo = {
                                        translation: "血魔",
                                        number: 0,
                                        intro: "体力牌导魔介质"
                                    }
                                    if (!target.tear) target.tear = {
                                        translation: "雪女",
                                        number: 0,
                                        intro: "冰属性导魔介质"
                                    }
                                    if (!target.taoyao) target.taoyao = {
                                        translation: "桃妖",
                                        number: 0,
                                        intro: "恢复体力导魔介质"
                                    }
                                    if (!target.dragon) target.dragon = {
                                        translation: "龙女",
                                        number: 0,
                                        intro: "雷属性导魔介质"
                                    }
                        ...
                        lingli: function () {
                            //
                            lib.config.xjb_count["xjb_chanter"].lingfa = lib.config.xjb_count["xjb_Fuaipaiyi"].lingfa =
                                ["xjb_soul_lingqiang", "xjb_soul_lingdun"];
                            //琪盎特儿的导魔介质        
                            ...
                            //
                            lib.config.xjb_count["xjb_xuemo"].lingtan = ["xin_guimeng_1"];
                        ...
                        title: function () {
                                ...
                                Object.keys(lib.config.xjb_count).forEach(function (item) {
                                    if (this[item].selectedTitle) lib.characterTitle[item] = '<a class=xjb_hunTitle href=#xjb_player' + item + ' onclick="location.hash=this.href">' + this[item].selectedTitle + '</a>'
                                        ...
                                        if (this[item].titles && this[item].titles.length) {
                                            ...
                                            lib.characterTitle[item] = '<a data-nature=xjb_hun href=#xjb_titlesCondition>获得称号方式</a>'
                                        }
                                    }
                                }, lib.config.xjb_count)
                            }
                            ...
                            let condition = {
                                ...
                                8: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得身份场二十五胜次",
                                9: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得身份场一百胜次",
                                10: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得身份场两百五十胜次",
                                11: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得斗地主场二十五胜次",
                                12: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得斗地主场一百胜次",
                                13: "江东铁壁:【角色专属:神甘宁|手杀徐盛】使用神甘宁|手杀徐盛获得斗地主场两百五十胜次",
                            }
                            lib.config.xjb_title.forEach(function (item, index) {
                                this[index] = item[0] + "<br>" + condition[index]
                            }, lib.xjb_title_condition)
                            let intro2 = game.xjb_Intro2()
                            intro2.style.display = "none"
                            //
                            let dialog = game.xjb_create.condition(lib.xjb_title_condition)
                            dialog.style.display = 'none'
                            dialog.buttons[0].parentNode.parentNode.remove()
                            dialog.setAttribute('id', 'xjb_titlesCondition')
                    ...
                    "xjb_10": {
                        win: function () {
                            ...
                            game.xjb_played_timesUp = function (player, num, bool) {
                                ...
                                let count = lib.config.xjb_count[name]
                                if (!count) return
                                if (!count["playedTimes" + num]) {
                                    count["playedTimes" + num] = 0
                                    if (count["win" + num]) count["playedTimes" + num] = count["win" + num]
                                } else {
                                ...
                                if (num == 1) {
                                    if (["zhu", "zhong", "nei", "fan"].contains(player.identity)) {
                                        if (!count["playedTimes_" + player.identity]) {
                                            count["playedTimes_" + player.identity] = 0
                                            count["playedTimes_" + player.identity] = count["win_" + player.identity]
                                        }
                                        else count["playedTimes_" + player.identity]++
                                ...
                                if (num === 2) {
                                    let iden = player.identity == "zhu" ? "landlord" : "farmer"
                                    if (!count["playedTimes_" + iden]) {
                                        count["playedTimes_" + iden] = 0
                                        count["playedTimes_" + iden] = count["win_" + iden]
                                    }
                                    else count["playedTimes_" + iden]++
                                    count["winRate_" + iden] =
                            ...
                            game.xjb_createWinObserver = function (player, num) {
                                return function wonderfulFrame() {
                                    if (ui.dialog.content.firstChild.innerHTML === "战斗胜利") {
                                        game.xjb_win(player, num);
                                        game.xjb_win(player, num, true);
                                    }
                                    if (ui.dialog.content.firstChild.innerHTML === "战斗失败") {
                                        game.xjb_played_timesUp(player, num)
                                        game.xjb_played_timesUp(player, num, true)
                                    }
                                    if (ui.dialog.content.firstChild.innerHTML === "战斗结束") {
                                        game.xjb_played_timesUp(player, num)
                                        game.xjb_played_timesUp(player, num, true)
                                    }
                    ...
                    "xjb_11": {
                        count: function () {
                            game.xjb_haveDaomo = game.xjb_hasDaomo = function (name) {
                                ...
                                if (typeof dataSource != "object") returnfalse
                                list = Object.keys(dataSource).filter(i => {
                                    return dataSource[i].number > 0
                                })
                                return list.length > 0;
                            }
                            game.xjb_getDaomo = game.xjb_addDaomo = function (player, type, add) {
                        ...
                        lingdan: function () {
                            ...
                            lib.translate.xin_guimeng = "你使用牌时，该牌效果变为【杀】【桃】【决斗】【火攻】【过河拆桥】【无中生有】中的一种"
                            ...
                            lib.translate.xjb_soul_lingqiang_info = "出牌阶段，你可以弃置一张牌然后对一名角色发射一点魔力。"
                            lib.skill.xjb_soul_lingdun = {
                                ...
                                filter: function (event, player) {
                                    ...
                                    if (player.countMark("_xjb_lingli") <= 0) return false;
                            ...
                            lib.skill.xjb_soul_fuhua = {
                                enable: "chooseToUse",
                                filter: function (event, player) {
                                    if (lib.config.xjb_count[player.name1].kind != "血族") return false
                                    if (player.hasSkill("xjb_soul_fuhua1")) return false
                                    if (event.type === 'dying') {
                                        if (player != event.dying) return false;
                                        return true;
                                    }
                                ...
                                content: function () {
                                    ...
                                    ui.xjb_giveStyle(player.node.avatar, { "background-image": "url('" + src + "xuemo4.jpg')" })
                                    player.addSkill("xjb_soul_fuhua1")
                                },
                                ai: {
                                    save: true
                                },
                            }
                            lib.translate.xjb_soul_fuhua = "蝠化"
                            lib.translate.xjb_soul_fuhua_info = "当你未蝠化时，你可变成蝙蝠，若此做，你的体力恢复至1点并可以在需要的时候视为使用或打出一张闪。"
                            lib.skill.xjb_soul_fuhua1 = {
                                onremove: function (player) {
                                    var src = lib.xjb_src + "sink/xjb_xuemo/"
                                    ui.xjb_giveStyle(player.node.avatar, { "background-image": "url('" + src + "xuemo1.jpg')" })
                            ...
                            lib.translate.xjb_soul_fuhua1 = "蝠化";
                            lib.translate.xjb_soul_fuhua1_info = "你可以在需要时，视为使用一张闪"
                        },
                        moliSkill: function () {
                            ...
                            lib.skill._xjb_lingliBeforeDeath = {
                                ...
                                forced: true,
                                content: function () {
                                    let num = trigger.player.countMark("_xjb_lingli");
                                    trigger.player.removeMark("_xjb_lingli", num);
                                    (trigger.source || trigger.player.previous).xjb_addlingli(num)
                                }
                            }
                        ...
                        play: function () {
                            ...
                            lib.soul.xjb_chanter = function () {
                                ...
                                game.xjb_dialog([
                                    ...
                                    let list = {}
                                    if (!lib.config.xjb_count.xjb_chanter.dialog.talkAboutLingli) list["1"] = ["谈论灵力"]
                                    else list["1"] = ["回顾灵力"]
                                    var talkAboutLingli = [
                                        [LH, myName, "green", "琪盎特儿小姐，咏唱使是怎样的呢？", library],
                                        [chanter, "琪盎特儿", "white", "咏唱使是和灵力打交道一门职业。灵力是自然的伟力，它飘渺，我们既不能看见它，也不能听见它，但是我们能够度量它。"],
                                        [, , , "但反过来，灵力却可以化作万物，可以成为最真实的东西，它可以成为徐徐清风，也可以成为似火骄阳，可如冬雪之彻骨，又如春雷之激荡。"],
                                        [, , , "如你所见，本馆的那一侧，正是我们一代代咏唱使探寻，牺牲，奉献的结果。我们以着自然与我们的先辈为傲。"],
                                        [LH, myName, "green", "众所周知，灵力人人可用，全倚仗咏唱使的努力。投身于此是伟大的。琪盎特儿小姐，你愿意将咏唱使的荣耀分享给我吗？"],
                                        [chanter, "琪盎特儿", "white", "当然可以，我乐意见到还有愿意承接咏唱使衣钵的人。"],
                                        [, , , "按照传统，我得把这一卷羊皮纸给你，你上面是灵力的理论知识。"],
                                        ["none", "提示", "white", "李华获得道具——羊皮纸，可在其角色进度一览中查看。每次读完后，双击便可以收起它。"],
                                        [LH, myName, "green", "不胜感激。"],
                                        [chanter, "琪盎特儿", "white", "虽然给了羊皮纸，但你肯定会有不懂之处，我便略讲一下吧。"],
                                        [chanter, "琪盎特儿", "white", "将卡牌放进阵法时，便会产生灵力。灵力在一个区域的空气中最多可以容纳10Ch，血魔的血色空间不能容纳灵力。空间一旦不能容纳灵力，灵力就一定会转化为魔力。灵力自身也会转化为魔力。", library],
                                        [, , , "灵力变成魔力时，会使能量变化，这一能量的变化的净收益是：得到一张牌，增加0.5点体力或上限"],
                                        [, , , "若拥有魔力，可以在两名角色间各放一个导魔介质，使得魔力向灵力高的区域移动。此时，魔力变成灵力时，也会使能量变化，恰好使你减一点体力或上限或废弃一个装备栏。"],
                                        [, , , "好了，这就是基本内容。"],
                                        [, , , "我接下来教授你一个简单的防身术——灵盾，还有，收下这50个导魔介质。"],
                                        ["none", "提示", , "获得导魔介质50个，可在角色进度中查询！"],
                                        [LH, myName, "green", "从今以后，我便也是咏唱使啦！"],
                                        [chanter, "琪盎特儿", "white", "祝贺你。在咏唱使之路上，还需多加勤勉。"],
                                    ]
                                    if (list["1"][0] === "谈论灵力") list["1"][1] = () => {
                                        let func = () => {
                                            if (!lib.config.xjb_count["xjb_newCharacter"]) lib.config.xjb_count["xjb_newCharacter"] = {}
                                            lib.config.xjb_count["xjb_newCharacter"].book = [{ headline: "灵力简论", type: "lingli" }]
                                            game.xjb_addDaomo("xjb_newCharacter", "tear", 10)
                                            game.xjb_addDaomo("xjb_newCharacter", "blood", 10)
                                            game.xjb_addDaomo("xjb_newCharacter", "taoyao", 10)
                                            game.xjb_addDaomo("xjb_newCharacter", "dragon", 10)
                                            game.xjb_addDaomo("xjb_newCharacter", "sun", 10)
                                            lib.config.xjb_count.xjb_chanter.dialog.talkAboutLingli = true
                                            game.saveConfig("xjb_count", lib.config.xjb_count)
                                        }
                                        game.xjb_dialog(talkAboutLingli, func)
                                    }
                                    else list["1"][1] = () => {
                                        game.xjb_dialog(talkAboutLingli.slice(10, 14), () => true)
                                    }
                                    game.xjb_create.chooseAnswer("你决定：", list, library)
                        ...
                        linglichang: function () {
                            window.xjb_lingli = {
                                daomo: {
                                    type: ["sun", "dragon", "blood", "tear", "taoyao", "xuemo"],
                                    event: {
                                        "sun": "xjb_fire",//金乌
                                    ...
                                    event_mark: {
                                        "_xjb_daomo_sun": "xjb_fire",//金乌
                                        "_xjb_daomo_dragon": "xjb_thunder",//龙女
                                        "_xjb_daomo_blood": "loseHp",//杜鹃
                                        "_xjb_daomo_tear": "xjb_ice",//雪女
                                        "_xjb_daomo_taoyao": "xjb_recover",//桃妖
                                        "_xjb_daomo_xuemo": "giveHpCard2"
                                    },
                        ...
                        logo: function () {
                            let createLogo = (str, size) => {
                                ...
                                div.appendChild(i)
                                div.imageSrc = ('ext:新将包:' + str).replace("/", ":")
                        ...
                        Marks: function () {
                            ...
                            lib.skill._xjb_daomo_dragon = {
                                marktext: xjbLogo.dragon(20),
                                intro: {
                                    name: xjbLogo.dragon(230),
                                    content: function (storage, player, skill) {
                                        return "能量值:" + storage + "C"
                                    },
                                }
                            }
                            lib.skill._xjb_daomo_taoyao = {
                                marktext: xjbLogo.taoyao(20),
                                intro: {
                                    name: xjbLogo.taoyao(230),
                                    content: function (storage, player, skill) {
                                        return "能量值:" + storage + "C"
                                    },
                                }
                            }
                            lib.skill._xjb_daomo_blood = {
                                marktext: xjbLogo.blood(20),
                                intro: {
                                    name: xjbLogo.blood(230),
                                    content: function (storage, player, skill) {
                                        return "能量值:" + storage + "C"
                                    },
                                }
                            }
                            lib.skill._xjb_daomo_tear = {
                                marktext: xjbLogo.tear(20),
                                intro: {
                                    name: xjbLogo.tear(230),
                                    content: function (storage, player, skill) {
                                        return "能量值:" + storage + "C"
                                    },
                                }
                            }
                            lib.skill._xjb_daomo_sun = {
                                marktext: xjbLogo.sun(20),
                                intro: {
                                    name: xjbLogo.sun(230),
                                    content: function (storage, player, skill) {
                                        return "能量值:" + storage + "C"
                                    },
                                }
                    ...
                    "xjb_12": {
                        ...
                        sub: function () {
                            ...
                            game.xjb_systemEnergyChange = function (num) {
                                ...
                                if (lib.config.xjb_systemEnergy <= 0) {
                                    if (num < 0) game.xjb_create.alert("魂币系统能量耗尽")
                    ...
                    "xjb_13": {
                        content: function () {
                            ...
                            get.xjb_fAgruments = function (value) {
                                let list = []
                                if (value === 'createCard' || value === 'createCard2') list = ['cardName', 'suit', 'number', 'nature']
                                if (value === 'gain') list = ['gain']
                                return list
                            }
                            lib.xjb_translate = {
                                //
                                ...
                                '轮数': 'game.roundNumber',
                                //
                                '其他角色': 'function(card,player,target){return player!=target}',
                                //
                                '火属性': '"fire"',
                                '雷属性': '"thunder"',
                                '冰属性': '"ice"',
                                ...
                                //players
                                '所选角色': 'result.targets',
                                '你所选角色': 'result.targets',
                                '你所选的角色': 'result.targets',
                                '你所选择的角色': 'result.targets',
                                '你选择的角色': 'result.targets',
                                '所有角色': 'game.players',
                                //
                                '体力': 'hp',
                                '体力值': 'hp',
                                ...
                                '选择角色': 'chooseTarget',
                                //特殊时机
                                '成为一张牌的目标': "useCardToTarget",
                                '成为牌的目标': "useCardToTarget",
                                '造成伤害': 'damageSource',
                                '造成伤害时': 'damageSource',
                                '造成伤害后': 'damageSource',
                                //
                            ...
                            if (true) {
                                ...
                                for (let i = 0; i < 100; i++) {
                                    ...
                                    lib.xjb_translate[i + "个"] = '' + i
                                    lib.xjb_translate[get.cnNumber(i) + "个"] = '' + i
                                }
                            ...
                            if (true) {
                                ...
                                list2.forEach((i, k) => {
                                    ...
                                    lib.xjb_translate[i + "后"] = list[k] + "End"
                                    ...
                                    lib.xjb_translate["令一名角色" + i + "后"] = "source:" + list[k] + "End"
                                    lib.xjb_translate["令一名角色" + i + "前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["令一名角色" + i + "之前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["令一名角色" + i + "结算后"] = "source:" + list[k] + "After"
                                    lib.xjb_translate["使一名角色" + i] = "source:" + list[k]
                                    lib.xjb_translate["使一名角色" + i + "时"] = "source:" + list[k] + "Begin"
                                    lib.xjb_translate["使一名角色" + i + "后"] = "source:" + list[k] + "End"
                                    lib.xjb_translate["使一名角色" + i + "之前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["使一名角色" + i + "结算后"] = "source:" + list[k] + "After"
                                    lib.xjb_translate["令一角色" + i] = "source:" + list[k]
                                    lib.xjb_translate["令一角色" + i + "时"] = "source:" + list[k] + "Begin"
                                    lib.xjb_translate["令一角色" + i + "后"] = "source:" + list[k] + "End"
                                    lib.xjb_translate["令一角色" + i + "前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["令一角色" + i + "之前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["令一角色" + i + "结算后"] = "source:" + list[k] + "After"
                                    lib.xjb_translate["使一角色" + i] = "source:" + list[k]
                                    lib.xjb_translate["使一角色" + i + "时"] = "source:" + list[k] + "Begin"
                                    lib.xjb_translate["使一角色" + i + "后"] = "source:" + list[k] + "End"
                                    lib.xjb_translate["使一角色" + i + "前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["使一角色" + i + "之前"] = "source:" + list[k] + "Before"
                                    lib.xjb_translate["使一角色" + i + "结算后"] = "source:" + list[k] + "After"
                                })
                            }
                            game.xjb_skillEditor = function () {
                                ...
                                function dispose(str, number) {
                                    ...
                                    list2.forEach(i => {
                                        ...
                                        i.forEach(a => {
                                            ...
                                            d = d.join('')
                                            list.push(lib.xjb_translate[d] || d)
                                        })
                                        list3.push(list)
                                    })
                                ...
                                idFree.addEventListener('keyup', e => {
                                    if (e.keyCode == 13) {
                                        idFree.value = ''
                                    }
                                ...
                                filterFree.addEventListener('keyup', e => {
                                    ...
                                    list = list.map(t => {
                                        return t.replace('trigger', 'event')
                                    })
                                ...
                                contentFree.changeWord = function (replaced, replacer) {
                                    contentFree.value = contentFree.value.replace(replaced, replacer)
                                    return true
                                }
                                contentFree.arrange = function () {
                                    ...
                                    const wonderA = ["火属性", "冰属性", "雷属性", '红色', '黑色', '梅花', '方片', '无花色', '黑桃', '红桃', '红心']
                                    for (let i = 0; i < wonderA.length; i++) {
                                        update(wonderA[i])
                                    }
                                    contentFree.changeWord(/你/g, '你 ')
                                    contentFree.changeWord(/玩家/g, '玩家')
                                    contentFree.changeWord(/目标/g, '目标')
                                    contentFree.changeWord(/当前回合角色/g, '当前回合角色')
                                    contentFree.changeWord(/\s\s/g, ' ')
                                }
                                contentFree.addEventListener('keyup', e => {
                                    ...
                                    back.skill.content = []
                                    if (contentFree.value.length === 0) return
                                ...
                                triggerFree.addEventListener('keyup', e => {
                    ...
                    "_xjb_remnantArea": {
                        ...
                        content: function () {
                            ...
                            for (let k in list) {
                                ...
                                for (let c = 0; c < a; c++) {
                                    player.useCard(game.createCard(k), player)
                    ...
                    "xin_xueqi": {
                        ...
                        content: function () {
                            'step 0'
                            player.fc_X(103, true, { onlyme: [trigger.player] })
                            player.removeSkill("xjb_soul_fuhua1")
                            var src = lib.xjb_src + "sink/xjb_xuemo/"
                            ui.xjb_giveStyle(player.node.avatar, {
                                "background-image": "url('" + src + "xuemo2.jpg')"
                            })
                            trigger.player.storage.lingliPosition = "blood"
                            trigger.player.xjb_updateLingli()
                            setTimeout(i => {
                                ui.xjb_giveStyle(player.node.avatar, {
                                    "background-image": "url('" + src + "xuemo1.jpg')"
                                })
                            }, 30000)
                        },
                    },
                ...
                translate: {
                    "xin_jincui": "尽瘁",
                    "xin_jincui_info": "每轮限一次，回合开始前，你可以弃置你全域内两张牌，然后将一张普通锦囊牌和一张火【杀】置于武将牌上。当前回合后你额外执行一个回合。",
                    "xin_chushi": "出师",
                    ...
                    "_UseHpCard_info": "",
                    "xin_xueqi": "血契",
                    "xin_xueqi_info": "当你对一名角色造成伤害时，你可解除你的蝠化状态，你与该角色交换体力牌，其进入血色空间。",
                    "xjb_lingpiao": "灵票",
                    "xjb_lingpiao_info": "一名其他角色灵力增加时，你可取消之，并用一张灵力支票代替。",
                    "xjb_guifan": "归返",
