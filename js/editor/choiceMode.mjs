...
const getPlayersList = () => {
    if (game.xjb_back.skill.kind === 'enable:"phaseUse"'
        && game.xjb_back.skill.type.includes("filterTarget")) {
        result.push(game.xjb_back.skill.contentAsync ? "事件的目标组" : "目标组")
    }
...
export class choiceMode {
    ...
    static pushCardsControl(father, { cn, value }) {
        ...
        const cardContainer = element("div").block().innerHTML("选择卡牌").fontSize("0.8em").addClass("xjb_hidden").setStyle("position", "relative").exit();
