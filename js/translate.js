window.XJB_LOAD_TRANSLATE = function (_status, lib, game, ui, get, ai) {
    ...
    let cards = {
        ...
        "xin_qinnangshu": "青囊",
        "xin_qinnangshu_info": "青囊:装备此牌，出牌阶段限一次，可对一名角色使用【桃】，每使用一张，则你与其各摸一张牌。",
        "card_lw": "文和乱武",
        "card_lw_info": "出牌阶段，对你自己使用，所有其他角色除非对其距离最近的角色使用【杀】，否则其弃置一张牌并失去一点体力。结算完后，你视为使用一张无距离限制的【杀】。",
        "xin_qinglong": "黄龙偃月刀",
        ...
        "xin_baiyin": "曜日银狮子",
        "xin_baiyin_info": "<br>狮怒:你受到伤害前，你立即反伤;若你此时体力值为1，你移去此牌并取消此次伤害。<br>你失去装备区里的该牌时立即销毁之，然后你恢复1点体力并装备【白银狮子】。",
        "xin_hutou": "虎头湛金枪",
