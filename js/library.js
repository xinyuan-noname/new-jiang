...
`,
      ...
      lingli: {
         "魂的货币体系": {
            ...
            浮流率=第〇等率*魂币量/能量量 n
            A魂币获取 n
            因击杀、重伤、满足条件而非直接抽奖获得称号所获得的魂币不消耗能量。n
            ...
            择木卡以及性转卡,只收到浮流率的调控.浮流率越高,价格越高. n
            A能量抽取 n
            魂币系统总部对于每个魂币系统做出的要求是：n
            每日打卡时，n
            1.若10H+E<0，对该系统进行E=H的补充n
            2.若10+H>=0，对抽取该系统0.01的能量n
            3.赠送3打卡点作为基金
            A魂能转化 n
            目前的魂能转化，有两种途径刘徽-祖冲之项目以及清零魂币。n
            刘徽-祖冲之项目规则如下：n
            E=3H n
            清零魂币则根据当前魂币总额进行转化：n
            规则如下：n
