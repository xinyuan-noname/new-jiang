...
|新选择如果|条件为result.bool的条件语句1|技能效果|
|新目标过滤|生成filterTarget的箭头函数|技能效果|
|新卡牌过滤|生成filterCard的箭头函数|技能效果|
|for-in|生成for-in循环|技能效果|
|for-of|生成for-of循环|技能效果|
|for-;;|生成for-;;循环|技能效果|
|do-while|生成do-while循环|技能效果|
|while-|生成while循环|技能效果|
